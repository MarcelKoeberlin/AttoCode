...
import datetime
import h5py
#os.add_dll_directory(r"C:\Program Files\Princeton Instruments\PICam")
# --- Configuration ---
...
def main():
    ...
    def on_save_clicked(event):
        """Saves the 'kept' spectrum to an hdf5 file."""
        ...
        file_index = 1
        while True:
            filename = f"XUV_{date_str_long}_{file_index:04d}.h5"
        ...
        try:
            with h5py.File(filepath, 'w') as f:
                ...
                f.create_dataset('counts', data=kept_spectrum)
